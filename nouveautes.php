...
<div class="contnvx">
    ...
    <div class="box1">
        <div class="rpz">
            <img src="cdm.jpg" onclick="playVideo('video5.mp4')">
        </div>
        <div class="rpz">
            ...
            <small>C'est le pari fou d'une mère prête à tout pour aider son fils à se réveiller du coma. <br>
                ...
                Thelma décide de réaliser à sa place les " 10 choses à faire avant la fin du monde " qu'il avait inscrites dans son journal intime. <br>
                En écoutant ces aventures, Louis verra combien la vie est belle et qu'il doit revenir ! <br>
                En accomplissant à quarante ans les rêves d'un ado, Thelma va vivre un voyage incroyable qui l'emmènera bien plus loin que ce qu'elle imaginait...</small>
                <br>
                <br>
                <h3 class="prix">15€</h3>
                <a href="Panier.php" class="button" onclick="add(1)"
                >&#9755; Ajouter au panier &#9754;
              </a>
        </div>
        ...
        <div class="rpz">
            ...
            <small>CRAZY BEAR est une comédie noire qui met en scène un groupe mal assorti de flics, de criminels, <br>
                de touristes et d’adolescents qui convergent tous au cœur d’une forêt du fin fond de la Georgie <br>
                 ...
                 <br>
                 <h3 class="prix">15€</h3>
                 <a href="Panier.php" class="button" onclick="add(2)"
                 >&#9755; Ajouter au panier &#9754;
               </a> 
        </div>
        <div class="rpz">
            <img src="crazybear.jpg" onclick="playVideo('video6.mp4')">   
        </div>

        <div class="rpz">
            <img src="dge.jpg" onclick="playVideo('video7.mp4')">
        </div>
        <div class="rpz">
            ...
            <br>
            <small>Madeleine, brillante et idéaliste jeune femme issue d'un milieu modeste, prépare l'oral de l'ENA dans la maison de vacances d'Antoine, en Corse. <br>
                 Un matin, sur une petite route déserte, le couple se trouve impliqué dans une altercation qui tourne au drame. <br>
                 ...
                 <br>
                 <h3 class="prix">15€</h3>
                 <a href="Panier.php" class="button" onclick="add(3)"
                 >&#9755; Ajouter au panier &#9754;
               </a>
        </div>
        ...
        <div class="rpz">
            ...
            <small>Depuis 2014, en France, <br>
                la Justice Restaurative propose à des personnes victimes et auteurs d’infraction de dialoguer dans des dispositifs sécurisés,<br>
                 encadrés par des professionnels et des bénévoles comme Judith, Fanny ou Michel.</small>
                 <br>
                 <br>
                 <h3 class="prix">15€</h3>
                 <a href="Panier.php" class="button" onclick="add(4)"
                 >&#9755; Ajouter au panier &#9754;
               </a>  
        </div>
        <div class="rpz">
            <img src="visage.jpg" onclick="playVideo('video8.mp4')"> 
 
        </div>

        <div class="rpz">
            <img src="reyes.jpg" onclick="playVideo('video9.mp4')">
        </div>
        <div class="rpz">
            ...
            <small>Le jeune Rá vit avec ses amis Culebro, Sere, Winny et Nano dans les rues de Medellin. <br>
                Leur espoir renaît lorsque le gouvernement promet à Rá le droit d’acquérir un terrain duquel sa famille avait été chassée, <br>
                ...
                <br>
                <h3 class="prix">15€</h3>
                <a href="Panier.php" class="button" onclick="add(5)"
                >&#9755; Ajouter au panier &#9754;
              </a>
        </div>
        ...
        <div class="rpz">
            ...
            <br>
            <small>Japon, XVIIIème siècle. Alors que le pouvoir impérial impose sa censure sur les artistes, le jeune Shunrô, <br>
                apprenti peintre, est exclu de son école à cause de son tempérament impétueux et du style peu conventionnel de ses estampes. <br>
                Personne n’imagine alors qu’il deviendra Hokusai, célèbre auteur de la Grande vague de Kanagawa.</small>
                <br>
                <br>
                <h3 class="prix">15€</h3>
                <a href="Panier.php" class="button" onclick="add(6)"
                >&#9755; Ajouter au panier &#9754;
              </a>
        </div>
        <div class="rpz">
            <img src="hokusai.jpg" onclick="playVideo('video10.mp4')">    

        </div>

        <div class="rpz">
            <img src="jw.jpg" onclick="playVideo('video1.mp4')">
        </div>
        <div class="rpz">
            ...
            <br>
            <small>John Wick découvre un moyen de vaincre l’organisation criminelle connue sous le nom de la Grande Table. <br>
                Mais avant de gagner sa liberté, Il doit affronter un nouvel ennemi qui a tissé de puissantes alliances à travers le monde et qui transforme les vieux amis de John en ennemis.</small>
                <br>
                <br>
                <h3 class="prix">15€</h3>
                <a href="Panier.php" class="button" onclick="add(7)"
                >&#9755; Ajouter au panier &#9754;
              </a>
        </div>
        ...
        <div class="rpz">
            ...
            <br>
            <h3 class="prix">15€</h3>
            <a href="Panier.php" class="button" onclick="add(8)"
            >&#9755; Ajouter au panier &#9754;
          </a>
        </div>
        <div class="rpz">
            <img src="mario.jpg" onclick="playVideo('video2.mp4')">  
  
        </div>

        <div class="rpz">
            <img src="dalva.jpg" onclick="playVideo('video3.mp4')">
        </div>
        <div class="rpz">
            <p>Sort le 22 mars 2023, issue de la catégorie : Drame</p>
            <br>
            ...
            <small>Dalva a 12 ans mais s'habille, se maquille et se vit comme une femme. <br>
                Un soir, elle est brusquement retirée du domicile paternel. D'abord révoltée et dans l'incompréhension totale, <br>
            ...
            <br>
            <h3 class="prix">15€</h3>
            <a href="Panier.php" class="button" onclick="add(9)"
            >&#9755; Ajouter au panier &#9754;
          </a>
        </div>
        ...
        <div class="rpz">
            ...
            <small>Avec Levan Tedaishvili, Giorgi Tabidze, Nadia Mikhalkova
                ...
                <br>
                <h3 class="prix">15€</h3>
                <a href="Panier.php" class="button" onclick="add(10)"
                >&#9755; Ajouter au panier &#9754;
              </a> 
        </div>
        <div class="rpz">
            <img src="4th.jpg" onclick="playVideo('video4.mp4')">   
        </div>
